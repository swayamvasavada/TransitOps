...
menuBackdrop: {
    ...
    backgroundColor: authColors.modalOverlay,
  },
menuSheet: {
  backgroundColor: authColors.cardBg,
    borderTopLeftRadius: 24, borderTopRightRadius: 24,
...
menuOptionLabel: { fontSize: 15, fontWeight: "600", color: authColors.textPrimary },
menuOptionSub: { fontSize: 12, color: authColors.textMuted, marginTop: 2 },
menuChevron: { fontSize: 20, color: authColors.textMuted, fontWeight: "300" },
menuDivider: { height: 1, backgroundColor: authColors.divider },
menuCancel: {
  marginTop: 16,
    alignItems: "center", paddingVertical: 14,
...
menuCancelText: { fontSize: 14, fontWeight: "600", color: authColors.deleteText },
